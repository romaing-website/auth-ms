package fr.rguillemot.website.backend.authms.controller
...
import fr.rguillemot.website.backend.authms.request.Register.RegisterRequest
import fr.rguillemot.website.backend.authms.request.Register.RegisterVerifyRequest
import fr.rguillemot.website.backend.authms.service.UserService
import fr.rguillemot.website.backend.authms.service.WebAuthnService
...
import fr.rguillemot.website.backend.authms.utils.b64urlDecode
...
class RegisterController(
    ...
    fun verifyRegistration(
        ...
        val clientDataJson = String(b64urlDecode(req.response.clientDataJson))
    ...
    private fun extractCoseKeyFromAttestationObject(attestationObjectB64: String): ByteArray {
        val attObj = b64urlDecode(attestationObjectB64)

package fr.rguillemot.website.backend.handler
...
class GlobalExceptionHandler {
    ...
    fun handleMaxSize(ex: MaxUploadSizeExceededException): ResponseEntity<ApiResponse<Any>> =
        ResponseEntity.badRequest()
            .body(ApiResponse(status = "error", message = "File too large"))
}
